Shader "Xiexe/Toon2.0/XSToon2.0 Sparkle (Okano)"
{
    Properties
    {	
		...
		_EmissionGreyShift("Emission Grey Shift", Range(0,3)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "../CGIncludes/OkanoSparkle.cginc"
