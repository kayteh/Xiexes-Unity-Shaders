Shader "Xiexe/Toon2.0/XSToon2.0 Rave (Okano)"
{
    Properties
    {	
        ...
        [NoScaleOffset]_EmissionScaleTex("Emission Scaling Texture", 2D) = "white" {}
        _EmissionSpeed("Emission Scroll Speed", Vector) = (0,0,0.05,0)
